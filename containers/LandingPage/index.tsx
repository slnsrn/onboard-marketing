...
const SlideList = [
  {
    ...
    title: 'Onboard',
    description:
      'Ofis işlerini bize bırakın, biz yapalım. Sizin yapacak daha önemli işleriniz vardır!',
    buttonText: 'Hemen Başla',
    buttonLink: '/contact',
  },
]
const sliderImage = '/landing/bg-image-1.jpg'

const image1 = '/landing/bg-image-12.jpg'

const image3 = '/landing/bg-image-7.jpg'

const image8 = '/landing/bg-image-8.jpg'
...
type BgImage = 1 | 2 | 3 | 4 | 5

const LandingPage = () => {
  const [bgImage, setBgImage] = useState<BgImage>(1)

  const changeImage = () => {
    const next = bgImage === 5 ? 1 : bgImage + 1
    setBgImage(next as BgImage)
  }
  ...
  return (
    <Fragment>
      ...
      <div className='slider-wrapper'>
        <Parallax bgImage={`/landing/bg-image-${bgImage}.jpg`} strength={700}>
          {SlideList.map((value, index) => (
            <div
              className='slide slide-style-2 slider-paralax flex align-items-center justify-content-center'
              key={index}
            >
                ...
                <div className='flex flex-wrap'>
                  <div className='col-lg-'>
                    <div className={`inner ${bgImage !== 5 ? 'ml-12' : ''} ${value.textPosition}`}>
                      ...
                      {value.description && (
                        <p className={`description ${descriptionStyle[bgImage]}`}>
                          {value.description}
                        </p>
                      )}
                      {value.buttonText ? (
      ...
      >
          ...
          <div className='flex flex-wrap'>
            <div className='col-lg-12'>
              <div className='section-title text-center mb--30 mb_sm--0'>
                ...
                <p className='text-lg'>
                  Reservio kullanan firmalar bakın bizim için neler söylüyor.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className='brand-wrapper'>
          <div className='container'>
            <div className='flex flex-wrap'>
              <div className='col-lg-12'>{renderBrands()}</div>
            </div>
          </div>
        </div>
      </Parallax>
